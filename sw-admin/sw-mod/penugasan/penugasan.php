        ...
        <div class="box-body">
          <div class="table-responsive">
            <table id="swdatatable" class="table table-bordered">
              ...
              <tbody>';
              $query="SELECT assignments.*,employees.employees_name,employees.employees_code FROM assignments INNER JOIN employees ON employees.id=assignments.employees_id ORDER BY assignments.assignment_id DESC";
