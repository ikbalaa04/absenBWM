...
if($mod=='karyawan' OR $mod =='jabatan' OR $mod=='shift' OR $mod=='lokasi' OR $mod=='libur' OR $mod=='user' OR $mod=='absensi' OR $mod=='cuty' OR $mod=='overtime' OR $mod=='attendance-correction' OR $mod=='penugasan'){
echo'
